...
function $translate($STORAGE_KEY, $windowProvider, $translateSanitizationProvider, pascalprechtTranslateOverrider) {
  ...
  var getFirstBrowserLanguage = function () {
    ...
    var nav = $windowProvider.$get().navigator,
        browserLanguagePropertyKeys = ['language', 'browserLanguage', 'systemLanguage', 'clientLanguage'],
        i,
        language;
 ...
 /**
   ...
   *
   * @description
   * Tells the module which key must represent the choosed language by a client in the storage.
   *
